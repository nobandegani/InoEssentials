...
UTexture2D* UFL_Extra::CreateTexture2dFromRenderTarget2d(UObject* WorldContextObject,
...
UTexture2D* UFL_Extra::CreateR16FTextureFromRenderTargetAlpha(UObject* WorldContextObject,
	UTextureRenderTarget2D* RenderTarget)
{
	if (!RenderTarget)
	{
